    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.cnn = torch.nn.Sequential(
            ...
            torch.nn.Conv2d(in_channels=channel_base*2, out_channels=4*channel_base, kernel_size=(3, 3), padding="same"),
            torch.nn.ELU(),
            torch.nn.BatchNorm2d(4 * channel_base),
            torch.nn.MaxPool2d((2, 2)),
            torch.nn.Dropout2d(self.dropout_p),

            torch.nn.Conv2d(in_channels=channel_base*4, out_channels=8*channel_base, kernel_size=(3, 3), padding="same"),
            torch.nn.ELU(),
            torch.nn.BatchNorm2d(8 * channel_base),
            torch.nn.MaxPool2d((2, 2)),
            torch.nn.Dropout2d(self.dropout_p),

            torch.nn.Conv2d(in_channels=channel_base*8, out_channels=16*channel_base, kernel_size=(3, 3), padding="same"),
            torch.nn.ELU(),
            ...
            torch.nn.Conv2d(in_channels=16*channel_base, out_channels=self.num_classes, kernel_size=(3, 3), padding="same"),
            torch.nn.ELU(),
