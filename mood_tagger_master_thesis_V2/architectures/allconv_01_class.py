...
class Net(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dense(
            torch.nn.Linear(8 * channel_base, 8 * channel_base),
            torch.nn.BatchNorm1d(8 * channel_base),
            torch.nn.Linear(8 * channel_base, 4 * channel_base),
            nn.Dropout(0.5),
            torch.nn.BatchNorm1d(4 * channel_base),
            torch.nn.Linear(4 * channel_base, self.num_classes),
            torch.nn.ReLU()
