    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dense = torch.nn.Sequential(            
            torch.nn.Linear(192 * channel_base, 96 * channel_base),
            torch.nn.BatchNorm1d(96 * channel_base),
            torch.nn.Linear(96 * channel_base, 48 * channel_base),
            torch.nn.Dropout(0.5),
            torch.nn.BatchNorm1d(48 * channel_base),
            torch.nn.Linear(48 * channel_base, self.num_classes),
            torch.nn.ReLU())
